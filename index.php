...
/**
 * Lists all ejsappbooking instances that are in a particular course with the course id being passed to this script
 *
...
$event = \mod_ejsappbooking\event\ejsappbooking_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

// Print the header.
$PAGE->set_url('/mod/ejsappbooking/view.php', array('id' => $id));
...
if (!$ejsapps = get_all_instances_in_course('ejsappbooking', $course)) {
    echo $OUTPUT->heading(get_string('noejsappbookings', 'ejsappbooking'), 2);
