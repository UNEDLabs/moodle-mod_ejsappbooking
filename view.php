...
if ($ejsappbooking->intro) { // If some text was written, show the intro.
    $intro = $OUTPUT->box(format_module_intro('ejsappbooking', $ejsappbooking, $cm->id), 'generalbox mod_introbox',
        'ejsappbookingintro');
}
...
if (!$remlabs) {
    ...
    echo html_writer::start_tag('div', array('class' => 'row'));
        ...
        echo '<p>' . get_string('time_zone', 'ejsappbooking') . ' ' . $USER->timezone . '&nbsp; '.
            ...
            echo '<div id="submitwrap"><button id="booking_btn" name="bookingbutton"  value="1" type="submit">' .
